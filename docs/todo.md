...
- [ ] **Disable temporary evaluation access after judging** — delete the production `EVALUATION_ACCESS_TOKEN` Worker secret. This immediately blocks new automatic persona sign-ins; revoke active evaluation sessions too if access must end before their normal expiry.
