...
- [ ] **Run 7 manual checklist** — 17 items in `~/projects/killmysaas-evals/runs/2026-08-11T00-41-30/manual-checklist.md`. This is the newest checklist and supersedes the run-5 copy. Same timing trap as before: the SPK weekly-digest item only observably fires **Mondays 07:00–07:15 UTC** (D-039 schedule + 6-day cooldown) — check it in that window or it will look broken when it isn't.
