...
- **Sourcing pipeline**: a kanban board with stages Identified, Contacted, Interested, Confirmed, Declined; contacts enroll with an optional score and rationale; cards move between stages via an explicit control and stay put across reload; card detail carries internal notes and a timestamped stage history.
